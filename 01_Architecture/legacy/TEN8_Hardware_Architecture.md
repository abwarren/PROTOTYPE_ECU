# TEN8 Hardware Architecture

## Overview

TEN8 ECU hardware is designed as a professional standalone ECU platform suitable for a wide range of engines.
...
```
[Power Supply] ──┬── [MCU Core: NXP S32K3] ──┬── [CAN FD x2]
                 │                           │
                 │                    ┌──────┴──────┐
                 │                    │  [Cellular]  │
                 │                    │  (Optional)  │
...
[Low-Side Out x4]                    [WBO2 Ckts]    [WiFi]
[Boost Solenoid]                                    [LTE]
```
