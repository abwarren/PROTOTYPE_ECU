...
The communication protocol defines how the ECU communicates with tuning software, mobile apps, and cloud services. It is transport-agnostic and brand-neutral.
...
- **Topic structure:** `{topic_prefix}/{vehicle_id}/{parameter}` (prefix from brand.json)
